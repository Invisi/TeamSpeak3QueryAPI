...
using TeamSpeak3QueryApi.Net.ClientQuery.Responses;
...
namespace TeamSpeak3QueryApi.Net.ClientQuery
{
    public class TeamSpeakClient : IDisposable
    {
        ...
        /// <summary>Creates a new instance of <see cref="ClientQueryClient"/> for localhost.</summary>
        public TeamSpeakClient()
        {
            Client = new QueryClient("127.0.0.1", 25639);
        }
        ...
        public Task<Responses.WhoAmI> WhoAmI() => Get<Responses.WhoAmI>();
        ...
        public Task<Responses.ServerVariable> GetServerVariable(
            params Enum.ServerVariable[] variables)
        {
            ...
            return Get<Responses.ServerVariable>(parameters);
        }
        ...
        {
            if (!System.Enum.TryParse(typeof(T).Name, out Event notification)
